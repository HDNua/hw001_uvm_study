...
$InterfaceFile = (Resolve-Path (Join-Path $StageDir "uvc\uart_tx\uart_tx_if.sv")).Path
$PackageFile   = (Resolve-Path (Join-Path $StageDir "uvc\uart_tx\uart_tx_pkg.sv")).Path
